  ...
  <div class="datepicker" :style="{width: width}">
    ...
    <template v-if="hasInput">
      <input type="text"
             ...
             @focus="onFocus"
             v-model="inputValue"/>
      <button v-if="clearButton && value" type="button" class="close" @click="clearinput">
        <span>&times;</span>
      </button>
    </template>
      ...
      <template v-for="(p, pan) in pane" >
        <div class="datepicker-inner">
          <div class="datepicker-body">
            <p @click="switchMonthView" style="cursor: pointer;">{{stringifyDayHeader(currDate, pan)}}</p>
            <div class="datepicker-weekRange">
              <span v-for="w in text.daysOfWeek">{{w}}</span>
            </div>
            <div class="datepicker-dateRange">
              <span v-for="d in dateRange[pan]" class="day-cell" :class="getItemClasses(d)" :data-date="stringify(d.date)" @click.self="daySelect(d.date, $event)">
                ...
                <div v-if="d.sclass !== 'datepicker-item-gray'"><slot :name="stringify(d.date)"></slot></div>
              </span>
            </div>
          </div>
        </div>
    ...
    <div class="datepicker-popup" :style="paneStyle" v-show="displayMonthView">
      ...
      <template v-for="(p, pan) in pane" >
        <div class="datepicker-inner">
          <div class="datepicker-body">
            <p @click="switchDecadeView" style="cursor: pointer;">{{stringifyYearHeader(currDate, pan)}}</p>
